	  ...
	  _createClass(B40, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.hidden2 || this.props.hidden3) {
	        ...
	        return _react2['default'].createElement(
	          'span',
	          { onClick: this.click.bind(this), style: { width: 50, marginLeft: 15, padding: 10 } },
	          this.props.message1
	        );
	      }
	    }
	  ...
	  _createClass(B41, [{
	    ...
	    value: function render() {
	      if (this.props.hidden2 || this.props.hidden3) {
	        ...
	        return _react2['default'].createElement(
	          'span',
	          { onClick: this.click.bind(this), style: { width: 50, marginLeft: 30, padding: 10 } },
	          this.props.message2
	        );
	      }
	    }
	  ...
	  _createClass(B42, [{
	    ...
	    value: function render() {
	      if (this.props.hidden2 || this.props.hidden3) {
	        ...
	        return _react2['default'].createElement(
	          'span',
	          { onClick: this.click.bind(this), style: this.props.dynamicStyle },
	          this.props.message3
	        );
	      }
	    }
	  ...
	  _createClass(Op0, [{
	    ...
	    value: function render() {
	      if (this.props.hidden2 || this.props.hidden3) {
	        ...
	        return _react2['default'].createElement(
	          'span',
	          { onClick: this.click.bind(this), style: { width: 50, marginLeft: 20, padding: 10 } },
	          '+'
	        );
	      }
	    }
	...
	var B4 = (function (_React$Component30) {
	  function B4(props) {
	    ...
	    DES_ws.onmessage = function (event) {
	      ...
	      if (that.state.group === gameArray[1] && that.state.group !== 'solo' || that.state.name === sender || extra === '%#8*&&^1#$%^' || d2 === 'CB#$42') {
	        switch (d2) {
	  ...
	  _createClass(B4, [{
	    ...
	    value: function calc() {
	      ...
	      delay(100).then(function () {
	        ...
	        m1 = that.state.mes1;
	        m2 = that.state.mes2;
	        var resP = that.state.resPrevious;
	        var ar5 = [m0, m2];
	        var usedTest = that.isElement(resP, [m0, m2]);
	        console.log('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$');
	      ...
	      }).then(this.forceUpdate()).then(delay(150)).then(function () {
	        var resString = that.state.res.toString();
	        that.setState({
