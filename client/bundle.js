...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetGoal = (function (_React$Component5) {
	  ...
	  _inherits(SetGoal, _React$Component5);
	...
	var Solutions2 = (function (_React$Component6) {
	  ...
	  _inherits(Solutions2, _React$Component6);
	...
	var B4 = (function (_React$Component8) {
	  function B4(props) {
	    var _this = this;
	    ...
	    DES_ws.onmessage = function (event) {
	      ...
	      if (that.state.group === gameArray[1] || name === sender || extra === '%#8*&&^1#$%^' || d2 == 'CB#$42') {
	        switch (d2) {
	          ...
	          case 'CD#$42':
	            var xm = that.state.chatMessage;
	            var xmess = extra + '<br>' + xm;
	            console.log(xm);
	            console.log(xmess);
	            var ar3 = xmess.split('<br>');
	            that.setState({
	              chatMessage: xmess,
	              chatArray: ar3
	            });
	  ...
	  _inherits(B4, _React$Component8);
