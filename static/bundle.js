...
/***/ function(module, exports, __webpack_require__) {
	...
	var shouldUpdateReactComponent = __webpack_require__(1);
	var warning = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var B4 = (function (_React$Component25) {
	  function B4(props) {
	    ...
	    ws.onmessage = function (event) {
	      ...
	      if (that.state.group === gameArray[1] && that.state.group !== 'solo' || that.state.name === sender || extra === '%#8*&&^1#$%^') {
	        switch (d2) {
	  ...
	  _inherits(B4, _React$Component25);
